...
//        },5000)
    ...
    fun skipControlCenter(position: Int) {
        ...
        when (position) {
            ...
            34 -> {
                intent.setClass(context, MMKVActivity::class.java)
            }
            35 -> {
                intent.setClass(context, GoogleFaceActivity::class.java)
            }
            36 -> {
                intent.setClass(context, ArcsoftFaceDetectionActivity::class.java)
            }
            37 -> {
                intent.setClass(context, ProtectEyeActivity::class.java)
            }
            38 -> {
    ...
    fun getDataList() {
        ...
        dataList.add("第一项----简单的布局ruuuuuuuuuuu")
        ...
        dataList.add("第35题-----鹅厂mmkv")
        dataList.add("第36题-----google原生人脸监测 ")
