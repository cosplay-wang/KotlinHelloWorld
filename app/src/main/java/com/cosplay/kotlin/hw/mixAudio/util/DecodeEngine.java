...
import com.cosplay.kotlin.hw.mixAudio.Constant;
import com.cosplay.kotlin.hw.mixAudio.DecodeOperateInterface;
import com.cosplay.kotlin.hw.mixAudio.MainHandler;
import com.cosplay.kotlin.hw.mixAudio.ssrc.SSRC;
import com.cosplay.kotlin.hw.mixAudio.util.encode.LogUtil;
...
@TargetApi(Build.VERSION_CODES.JELLY_BEAN) public class DecodeEngine {
   ...
   * @param decodeOperateInterface 解码过程回调
   */
  public boolean decodeMusicFile(String musicFileUrl, String decodeFileUrl,
    ...
    decodeFileUrl = decodeFileUrl.substring(0, decodeFileUrl.lastIndexOf("."));
    pcmFilePath = decodeFileUrl + ".pcm";
    String wavFilePath = decodeFileUrl + ".wav";
      convertPcmFileToWaveFile(pcmFilePath, wavFilePath, sampleRate, channelCount, 16);
