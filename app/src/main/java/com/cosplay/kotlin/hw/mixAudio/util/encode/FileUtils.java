package com.cosplay.kotlin.hw.mixAudio.util.encode;
...
public class FileUtils {
   ...
   * 手机的缓存根目录
   */
  public static String sDataRootPath = APP.Companion.getContext().getCacheDir().getPath();
  ...
  public static String getCacheRootDirectory() {
    ...
    if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
      return APP.Companion.getContext().getExternalCacheDir().getAbsolutePath();
    } else {
      return APP.Companion.getContext().getCacheDir().getAbsolutePath();
    }
  }
