...
import com.cosplay.audiocompose.AudioAPP;
...
public class FileUtils {
   ...
   * 手机的缓存根目录
   */
 // public static String sDataRootPath = AudioAPP.context.getCacheDir().getPath();
  ...
  public static String getCacheRootDirectory() {
    ...
    if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
      return AudioAPP.context.getExternalCacheDir().getAbsolutePath();
    } else {
      return AudioAPP.context.getCacheDir().getAbsolutePath();
    }
  }
